...
#define NODEPROXY_INBOUND_MARK (5678)
#define NODEPROXY_OUTBOUND_MARK (8765)

#define NODEPROXY_INBOUND_PORT (15008)
#define NODEPROXY_INBOUND_PLAINTEXT_PORT (15006)
#define NODEPROXY_OUTBOUND_PORT (15001)
